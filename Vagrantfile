...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "sandorkhan-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/brnr"
  #   chef.validation_client_name = "brnr-validator"
  #   chef.validation_key_path = ".chef/brnr-validator.pem"
  # end
end
